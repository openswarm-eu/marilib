...
#run basic.py
ExecStart=/usr/bin/tmux new-session -s marilib -d "/home/pi/marilib/venv/bin/python /home/pi/marilib/marilib/cli/edge.py -m mqtts://argus.paris.inria.fr:8883 -p /dev/ttyACM10 --metrics-probe-interval 5"
Type=forking
